...
- **Public grammar is generated.** `public-commands.toml` is the authored source; `public_commands_check.py` reports what is stale. Removed public forms must fail normally; never add aliases or migration redirects.
