...
The 2026-08-02 ceremony reduction (verify tiers as execution profiles, code_review unwired on bot-covered workspaces, assessor bounded) is a live rollout judged by the sweep, not a settled fact. Precondition: any window run.
