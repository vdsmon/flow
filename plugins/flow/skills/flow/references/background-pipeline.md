...
When you need to answer non-interactively and `claude --resume --print` refuses (the session is running as a background agent), see verb-evolve §6C for the proven PTY-attach recipe.
