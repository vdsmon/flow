...
`freshness` is a gate, not a report: scrutinize.md blocks a merge while the brief is stale or
...
def cli_main(argv: list[str]) -> int:
    ...
    # `freshness` is read as a gate: scrutinize.md blocks a merge while the brief is stale or
    # missing.
